    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-100 text-slate-900">
      <div className="w-full max-w-xl bg-white border border-slate-200 p-8 rounded-3xl shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Criar Novo Bazar</h1>
        ...
        <form onSubmit={handleOpenCheckout} className="space-y-5">
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 p-3 rounded-2xl bg-slate-50 border border-slate-200">
              <div className="w-16 h-16 rounded-2xl bg-white border border-slate-300 flex items-center justify-center overflow-hidden flex-shrink-0">
                {logoPreview ? (
            ...
            <div className="p-5 rounded-2xl border-2 border-emerald-500 bg-emerald-50/60 flex items-center justify-between">
              <div>
                <div className="flex items-center space-x-2">
                  <span className="font-extrabold text-slate-900 text-base">Assinatura Mensal SaaS</span>
