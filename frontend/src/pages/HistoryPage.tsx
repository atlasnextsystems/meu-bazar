                ...
                {filteredSales.map((sale) => (
                  <tr key={sale.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition">
                    ...
                    <td className="p-4">
                      ...
                      <div className="text-xs text-slate-500">{sale.items.length} peça(s)</div>
                    </td>
                    <td className="p-4">
        ...
        {selectedSale && (
          <div className="space-y-4">
            <div className="p-5 rounded-2xl bg-slate-900 text-white font-mono text-xs space-y-3">
              ...
              <div className="flex justify-between text-sm font-bold pt-2 border-t border-slate-800 text-emerald-400">
